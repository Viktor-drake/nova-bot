...
const QUOTAS = {
  "Гость":    { msgs: 10,  voice: 0,  tokens: 20_000 },
  "Участник": { msgs: 50,  voice: 15, tokens: 80_000 },
  "VIP":      { msgs: 150, voice: 45, tokens: 300_000 },
  "Founder":  { msgs: Infinity, voice: Infinity, tokens: Infinity },
};

const MONTH_CAP_USD = parseFloat(process.env.NOVA_MONTH_CAP_USD || "30");
